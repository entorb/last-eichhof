...
export const GAME: Pattern = {
  bpm: 132,
  bass: [N.C2, N.C2, 0, N.C2, N.G2, 0, N.G2, 0, N.A2, N.A2, 0, N.A2, N.F2, 0, N.F2, 0],
  lead: [N.C4, 0, N.E4, N.G4, 0, N.E4, N.C4, 0, N.D4, 0, N.F4, N.A4, 0, N.F4, N.D4, 0],
}
...
export class Music {
  ...
  private tick(): void {
    ...
    while (this.nextTime < now + 0.12) {
      ...
      const bass = p.bass[i]
      const lead = p.lead[i]
      if (bass) this.synth.note(bass, dur * 0.9, "triangle", 0.16, this.nextTime)
