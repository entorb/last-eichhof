...
export function endGameAndShowScores(switcher: SceneSwitcher, game: { abortGame(): void }): void {
  game.abortGame()
  switcher.stop("Game")
...
export function continueToNextLevel(switcher: SceneSwitcher, run: { level: number }): void {
